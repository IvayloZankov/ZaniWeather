...
public class Constants {
    ...
    public static final String ICON_WEATHER_CLEAR = "clear";
    public static final String ICON_WEATHER_CLOUDS = "clouds";
    public static final String ICON_WEATHER_RAIN = "rain";
    public static final String ICON_WEATHER_THUNDERSTORM = "thunderstorm";
    public static final String ICON_WEATHER_SNOW = "snow";
